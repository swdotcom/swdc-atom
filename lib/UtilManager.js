...
utilMgr.getLoginUrl = (loginType) => {
    ...
    if (loginType === 'github') {
        ...
        loginUrl = `${api_endpoint}/auth/github?plugin_token=${encodedJwt}&plugin=${utilMgr.getPluginType()}&redirect=${launch_url}`;
    } else if (loginType === 'google') {
        // google signup/login flow
        loginUrl = `${api_endpoint}/auth/google?plugin_token=${encodedJwt}&plugin=${utilMgr.getPluginType()}&redirect=${launch_url}`;
    } else if (!authType) {
