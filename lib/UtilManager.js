...
const CUSTOM_DATE_START = 1556064000;
const CUSTOM_DATE_END = 1556668800;

const PLUGIN_ID = 7;

let telemetryOn = true;
let statusView = new KpmStatusView();
// let customDashView = new CustomDashboardManager();
...
utilMgr.getCustomDashboardFile = () => {
  let file = utilMgr.getSoftwareDir();
  if (utilMgr.isWindows()) {
...
//TODO: make different from normal dashboard
// utilMgr.showCustomDashboard = () => {
//
//   console.log('Custom Dashboard prompt was toggled!');
//
//   customDashView.panel.isVisible() ?
//   customDashView.panel.hide() :
//   customDashView.panel.show()
//
//   // No callback here, but when the date range has been entered,
//   // customDashView will close itself and call launchCustomDashboard()
// }

utilMgr.launchCustomDashboard = async ([start = CUSTOM_DATE_START, end = CUSTOM_DATE_END]) => {
  // launch custom CodeTime filePath
  let file = utilMgr.getCustomDashboardFile();
