...
export default class SessionManager {
  ...
  chekUserAuthenticationStatus() {
    ...
    checkingStatus = true;
    console.log("checking user authntication status");
          ...
          atom.confirm({
            ...
            buttons: {
              Login: () => {
                ...
                this.launchWebUrl(
                  `${appConstants.getLaunchUrl()}/login?token=${tokenVal}`
                );
              }
            }
          });
  ...
  showStatus(msg) {
    // TODO: figure out how to use the status bar
    console.log(`${msg}`);
    statusView.display(msg);
  }
}
