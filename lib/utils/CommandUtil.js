...
import { toggleZenMode, enterFullScreen, exitFullScreen } from "../managers/ScreenManager";
import {
...
import { editPauseSlackNotifications, editSlackAwayStatus, editSlackAwayText, editScreenMode } from "../managers/ConfigManager";
    ...
    subscriptions.add(
        atom.commands.add('atom-workspace', {
            'Code-Time:refresh-stats-nodes': () => {
                providerMgr.getTreeProvider().rebuildStatsItems();
            },
        })
    );
