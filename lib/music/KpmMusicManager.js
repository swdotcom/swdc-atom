 ...
 */
    ...
    async showSpotifyPlaylists(serverIsOnline) {
        ...
        if (
            ...
            let _self = this
            filteredSpotifyPlaylists = filteredSpotifyPlaylists.map(
                async element => {
                    element['isPlaying'] =
    ...
    //
    async refreshPlaylistForPlayer(serverIsOnline) {
    ...
    async initializeSpotify() {
        if (
            ...
            if (oauthResult && oauthResult.auth) {
                ...
                this.KpmMusicStoreManagerObj.updateSpotifyAccessInfo(
                    oauthResult.auth
                )
            } else {
