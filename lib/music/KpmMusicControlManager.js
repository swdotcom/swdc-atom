...
import { SPOTIFY_LIKED_SONGS_PLAYLIST_NAME, api_endpoint } from '../Constants'
...
export default class KpmMusicControlManager {
    ...
    async previous(playerName = null) {
        ...
        let device = await musicMgr.getActiveSpotifyTitleAndTooltip()
    ...
    async play(playerName = null) {
        ...
        let device = musicMgr.getActiveSpotifyDevicesTitleAndTooltip()
