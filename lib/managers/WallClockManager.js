...
wallClockMgr.updateWcTime = () => {
    ...
    wallClockMgr.updateTimeData(SECONDS_INCREMENT);
};
...
wallClockMgr.updateTimeData = seconds_to_increment => {
    timeSummaryDataMgr.updateEditorSeconds(seconds_to_increment);
};
