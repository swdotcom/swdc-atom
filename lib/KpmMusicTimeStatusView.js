...
export default class KpmMusicTimeStatusView {
          ...
          atom.commands.dispatch(
            ...
            await getRunningTrack().then((track) => {
              ...
              if(track.state == 'paused') {
                $('#play-image').attr("src","data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAsAAAALCAYAAACprHcmAAAAJklEQVQoU2NkgIL/////h7EZGRkZ0fkgOcZRxaBQYGQEB8RQDA0AgnNYDJUbxzcAAAAASUVORK5CYII=");
                atom.commands.dispatch(
                  atom.views.getView(atom.workspace),
                  "Music-Time:play"
                );
  ...
  async display(msg, icon,tooltip, track) {
    ...
    let playTooltip = "Click to play song";
    let pauseTooltip = "Click to pause song";
    ...
    //      "' style=\"cursor: pointer;\" title='" +
    //      tooltip +
    //     "'><img width='11' height='11' src='data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAsAAAALCAYAAACprHcmAAAAJklEQVQoU2NkgIL/////h7EZGRkZ0fkgOcZRxaBQYGQEB8RQDA0AgnNYDJUbxzcAAAAASUVORK5CYII='/></span>";
    ...
    this.currentTrack.innerHTML = "<span id='music-current-control-href' class='" +
    iconClass +
     "' style=\"cursor: pointer;\" title='" +
     tooltip +
