...
const {getSlackStatus, getSlackPresence, getSlackDnDInfo} = require("../managers/SlackManager");
...
export default class CodeTimeProvider {
    ...
    async buildFlowNodes() {
      ...
      // slack status setter
      console.log("slack status: ", slackStatus);
...
$(document).on('click', '#switch-account-button', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#slack-dock-change', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#dark-mode-disable', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#dark-mode-enable', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
      'Code-Time:toggle-dark-mode',
      "click"
...
$(document).on('click', '#slack-adjust-change', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
      'Code-Time:toggle-dark-mode',
      "click"
...
$(document).on('click', '#slack-presence-active', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#slack-presence-away', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#pause-slack-notifications', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#enable-slack-notifications', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
...
$(document).on('click', '#update-slack-status', async () => {
  atom.commands.dispatch(
      atom.views.getView(atom.workspace),
