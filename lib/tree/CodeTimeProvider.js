...
import { getConfigSettingsTooltip, getConfigSettings } from '../managers/ConfigManager';
...
export default class CodeTimeProvider {
    ...
    async buildMetricsNodes(data) {
      ...
      liItems.push(this.buildMetricItem(
        ...
        data.averageDailyCodeTimeMinutes,
        data.globalAverageDailyCodeTimeMinutes,
        false,
        refClass));

      // ACTIVE CODE-TIME node
      liItems.push(this.buildMetricItem(
        "code-time",
        "Active code time",
        codeTimeSummary.activeCodeTimeMinutes,
        data.averageDailyActiveCodeTimeMinutes,
        data.globalAverageDailyActiveCodeTimeMinutes,
        false,
        refClass));
    ...
    async buildFlowNodes() {
      ...
      const settingsTooltip = getConfigSettingsTooltip();
