...
export default class CodeTimeProvider {
    ...
    renderTree() {
        let html = this.treeGenerator(true, true, true);
        $('div.structure-view>div>ol').html(html);
        this.hideLoader();
    }

    rebuildMetricItems() {
      let html = this.treeGenerator(true, true, false);
      $('div.structure-view>div>ol').html(html);
    }

    rebuildMenuItems() {
      let html = this.treeGenerator(true, false, false);
      $('div.structure-view>div>ol').html(html);
    }
    ...
    async treeGenerator(menuItems = true, metricItems = false) {
