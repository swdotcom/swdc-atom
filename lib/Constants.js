...
export const CODE_TIME_PLUGIN_ID = 7;
export const MUSIC_TIME_PLUGIN_ID = 13;

export const SOFTWARE_DIR = ".software";
...
export const CODE_TIME_EXT_ID = 'softwaredotcom.swdc-atom';
...
export const GITHUB_ISSUE_URL = 'https://github.com/swdotcom/swdc-atom/issues';
