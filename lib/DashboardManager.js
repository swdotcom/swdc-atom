            ...
            .then(resp => {
                if (utilMgr.isResponseOk(resp)) {
                    ...
                    if (
                        ...
                        delete resp.data.currentDayMinutes;
                        delete resp.data.currentDayKeystrokes;
                        delete resp.data.currentDayKpm;
                        delete resp.data.currentDayLinesAdded;
                        delete resp.data.currentDayLinesRemoved;
                    }
