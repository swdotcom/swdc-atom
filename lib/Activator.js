...
export default {
  ...
  async initializePlugin(state, initializedUser) {
    ...
    if (utilMgr.isCodeTime()) {
      ...
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "Music-Time:refreshPlaylist": () => musicMgr.refreshClearPlaylists()
        })
      );
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "Music-Time:generateUsersWeeklyTopSongs": () => musicMgr.generateUsersWeeklyTopSongs()
        })
      );
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
      ...
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "Music-Time:web-dashboard": () => musicMgr.displayMusicTimeMetricsMarkdownDashboard()
        })
      );
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
