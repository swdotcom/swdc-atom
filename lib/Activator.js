...
export default {
  ...
  async initializePlugin(state, initializedUser) {
    ...
    if (utilMgr.isCodeTime()) {
      ...
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "Music-Time:disconnectSpotify": () => musicControlMgr.disconnectSpotify()        
        })
      );
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
      ...
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "Music-Time:launchTrackPlayer": () => musicControlMgr.launchTrackPlayer(PlayerName.SpotifyWeb)
        })
      );
      ...
      this.subscriptions.add(
        atom.commands.add("atom-workspace", {
          "musictime.generateGlobalPlaylist": () => musicMgr.createOrRefreshGlobalTopSongsPlaylist()
